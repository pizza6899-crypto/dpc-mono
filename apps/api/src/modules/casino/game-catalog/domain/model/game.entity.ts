...
export class CasinoGame {
  ...
  get rtp(): Prisma.Decimal | null {
    return this._rtp;
  }
  get volatility(): string | null {
  ...
  get translations(): GameTranslation[] {
  ...
  update(
    ...
    if (params.contributionRate !== undefined)
      this._contributionRate = params.contributionRate;
