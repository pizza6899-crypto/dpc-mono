...
export class GameRound {
    ...
    public addBet(amount: Prisma.Decimal, gameAmount: Prisma.Decimal | null): void {
        if (this.isCompleted) {
            throw new CasinoGameRoundException(CasinoErrorCode.ROUND_ALREADY_COMPLETED, `Cannot add bet to a completed round: ${this.id}`);
        }
        if (amount.isNegative()) {
            throw new CasinoGameRoundException(CasinoErrorCode.INVALID_AMOUNT, `Bet amount cannot be negative: ${amount.toString()}`);
        }
    ...
    public addWin(amount: Prisma.Decimal, gameAmount: Prisma.Decimal | null): void {
        if (amount.isNegative()) {
            throw new CasinoGameRoundException(CasinoErrorCode.INVALID_AMOUNT, `Win amount cannot be negative: ${amount.toString()}`);
        }
    ...
    public addRefund(amount: Prisma.Decimal, gameAmount: Prisma.Decimal | null): void {
        if (amount.isNegative()) {
            throw new CasinoGameRoundException(CasinoErrorCode.INVALID_AMOUNT, `Refund amount cannot be negative: ${amount.toString()}`);
        }
    ...
    public addJackpot(amount: Prisma.Decimal, gameAmount: Prisma.Decimal | null): void {
        if (amount.isNegative()) {
            throw new CasinoGameRoundException(CasinoErrorCode.INVALID_AMOUNT, `Jackpot amount cannot be negative: ${amount.toString()}`);
        }
    ...
    public addComp(amount: Prisma.Decimal): void {
        if (amount.isNegative()) {
            throw new CasinoGameRoundException(CasinoErrorCode.INVALID_AMOUNT, `Comp amount cannot be negative: ${amount.toString()}`);
        }
    ...
    public addJackpotContribution(amount: Prisma.Decimal): void {
        if (amount.isNegative()) {
            throw new CasinoGameRoundException(CasinoErrorCode.INVALID_AMOUNT, `Jackpot contribution amount cannot be negative: ${amount.toString()}`);
        }
