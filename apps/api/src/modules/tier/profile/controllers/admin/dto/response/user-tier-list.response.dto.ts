...
export class UserTierListItemResponseDto {
  @ApiProperty({
    description: 'Unique identifier for the record / 레코드 고유 ID',
  })
  id: string;
  ...
  @ApiProperty({
    nullable: true,
    description: 'End date of the grace period / 강등 유예 종료 일시',
  })
  ...
  @ApiProperty({
    description:
      'Summary: Has any custom benefit overrides / 커스텀 혜택 오버라이드 존재 여부',
  })
