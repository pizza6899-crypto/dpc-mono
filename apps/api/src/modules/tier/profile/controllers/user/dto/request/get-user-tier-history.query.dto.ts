...
export class GetUserTierHistoryQueryDto extends createPaginationQueryDto({ defaultSortBy: 'changedAt' }, ['changedAt']) {
    ...
    @ApiPropertyOptional({ enum: TierChangeType, description: 'Change type / 변경 유형' })
    @IsOptional()
