...
export class UpdateUserTierCustomService {
    ...
    async execute(userId: bigint, command: UpdateUserTierCustomCommand): Promise<void> {
        ...
        if (command.customWeeklyLossbackRate !== undefined) userTier.customWeeklyLossbackRate = command.customWeeklyLossbackRate !== null ? new Prisma.Decimal(command.customWeeklyLossbackRate) : null;
        if (command.customMonthlyLossbackRate !== undefined) userTier.customMonthlyLossbackRate = command.customMonthlyLossbackRate !== null ? new Prisma.Decimal(command.customMonthlyLossbackRate) : null;
