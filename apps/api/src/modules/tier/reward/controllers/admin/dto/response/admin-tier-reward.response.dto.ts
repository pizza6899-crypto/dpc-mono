...
export class AdminTierRewardResponseDto {
    ...
    @ApiProperty({ description: 'Claimed At / 수령일시', required: false, nullable: true })
    claimedAt: Date | null;

    @ApiProperty({ description: 'Expires At / 만료일시', required: false, nullable: true })
    expiresAt: Date | null;

    @ApiProperty({ description: 'Cancelled At / 취소일시', required: false, nullable: true })
    cancelledAt: Date | null;

    @ApiProperty({ description: 'Cancel Reason / 취소 사유', required: false, nullable: true })
