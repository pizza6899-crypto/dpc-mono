...
export class TierConfigAdminController {
    ...
    @ApiOperation({
        ...
        description: 'Retrieves global settings for the tier system, such as whether promotion/downgrade and bonuses are enabled. / 승급/강등 및 보너스 활성화 여부 등 티어 시스템의 전역 설정을 조회합니다.',
    })
    ...
    @ApiOperation({
        ...
        description: 'Updates global settings for the tier system. / 티어 시스템의 전역 설정을 수정합니다.',
    })
    @ApiStandardResponse(TierConfigAdminResponseDto)
    @AuditLog({
