...
export class AdminMemoAdminController {
  ...
  @ApiOperation({
    ...
    description:
      'Create a new memo for an admin or associate it with a domain (e.g., Deposit). / 새로운 관리자 메모를 생성하거나 특정 도메인(예: 입금)에 연결합니다.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Find memos associated with a specific domain target. / 특정 도메인 대상에 연결된 메모 목록을 조회합니다.',
  })
  @ApiStandardResponse(AdminMemoResponseDto, {
    status: 200,
