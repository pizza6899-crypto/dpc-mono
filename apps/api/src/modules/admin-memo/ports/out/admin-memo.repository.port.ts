...
export interface AdminMemoRepositoryPort {
    ...
    findByTargets(type: AdminMemoTargetType, targetIds: bigint[]): Promise<AdminMemo[]>;
    findCountsByTargets(type: AdminMemoTargetType, targetIds: bigint[]): Promise<Map<bigint, number>>;
    findLatestByTargets(type: AdminMemoTargetType, targetIds: bigint[]): Promise<Map<bigint, AdminMemo>>;
}
