...
export interface WageringContributionLogRepositoryPort {
     ...
     */
    findByRequirementId(wageringRequirementId: bigint): Promise<WageringContributionLog[]>;
}

export const WAGERING_CONTRIBUTION_LOG_REPOSITORY = Symbol('WAGERING_CONTRIBUTION_LOG_REPOSITORY');
