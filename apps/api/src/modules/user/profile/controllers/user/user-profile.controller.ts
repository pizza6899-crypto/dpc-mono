...
export class UserProfileController {
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve detailed profile information of the currently logged-in user. / 현재 로그인한 사용자의 상세 프로필 정보를 조회합니다.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Update personal profile information such as nickname, language, and timezone. / 닉네임, 언어, 타임존 등 본인의 프로필 정보를 수정합니다.',
  })
  @AuditLog({
  ...
  @ApiOperation({
    ...
    description:
      'Update the user nickname, including duplicate checks and forbidden word filtering. / 본인의 닉네임을 수정합니다. (중복 검사 및 금지어 필터링 포함)',
  })
  @AuditLog({
    type: LogType.ACTIVITY,
    category: 'USER',
  ...
  @ApiOperation({
    ...
    description:
      'Update the user avatar using an uploaded file ID. / 업로드된 파일 ID를 사용하여 본인의 아바타를 수정합니다.',
  })
  @AuditLog({
    type: LogType.ACTIVITY,
    category: 'USER',
  ...
  @ApiOperation({
    ...
    description:
      'Updates the logged-in user password. / 로그인한 사용자의 비밀번호를 변경합니다.',
  })
  @AuditLog({
    type: LogType.ACTIVITY,
    category: 'USER',
  ...
  @ApiOperation({
    ...
    description:
      'Update the user primary and play currency settings. / 본인의 대표 통화 및 플레이 통화 설정을 수정합니다.',
  })
  @AuditLog({
    type: LogType.ACTIVITY,
    category: 'USER',
