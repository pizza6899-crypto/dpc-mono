...
import { Language, UserRoleType, UserStatus, ExchangeCurrencyCode } from '@prisma/client';
...
export class MyProfileResponseDto {
    ...
    @ApiProperty({ description: 'Primary Currency / 주 통화', enum: ExchangeCurrencyCode })
