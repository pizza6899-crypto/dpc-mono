...
import { User, UserNotFoundException, DuplicatePhoneNumberException } from '../domain';
...
export class GetUserService {
   ...
   */
  async ensurePhoneNumberAvailable(phoneNumber: string, excludeUserId?: bigint): Promise<void> {
