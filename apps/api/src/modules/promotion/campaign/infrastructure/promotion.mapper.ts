// src/modules/promotion/campaign/infrastructure/promotion.mapper.ts
...
export class PromotionMapper {
  ...
  toDomain(prismaModel: any): Promotion {
    return Promotion.fromPersistence({
      ...
      maxUsagePerUser: prismaModel.maxUsagePerUser,
      periodicResetType: prismaModel.periodicResetType,
      applicableDays: prismaModel.applicableDays,
      applicableStartTime: prismaModel.applicableStartTime,
      applicableEndTime: prismaModel.applicableEndTime,
