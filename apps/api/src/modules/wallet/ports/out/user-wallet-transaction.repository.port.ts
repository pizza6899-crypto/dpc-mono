...
import type { UserWalletTransaction } from '../../domain/model/user-wallet-transaction.entity';
import type { UserWalletTransactionSearchOptions } from './user-wallet-transaction.search-options';
