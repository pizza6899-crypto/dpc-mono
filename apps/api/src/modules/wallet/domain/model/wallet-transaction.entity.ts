...
export class WalletTransaction {
    private constructor(
        ...
        public readonly detail: WalletTransactionDetail,
    ...
    private validate(): void {
        const totalChange = this.detail.mainBalanceChange.add(this.detail.bonusBalanceChange);
    ...
    static fromPersistence(data: {
        ...
        const detailMapping: WalletTransactionDetail = {
            mainBalanceChange: data.detail?.mainBalanceChange ?? zero,
            mainBeforeAmount: data.detail?.mainBeforeAmount ?? zero,
            mainAfterAmount: data.detail?.mainAfterAmount ?? zero,
            bonusBalanceChange: data.detail?.bonusBalanceChange ?? zero,
            bonusBeforeAmount: data.detail?.bonusBeforeAmount ?? zero,
            bonusAfterAmount: data.detail?.bonusAfterAmount ?? zero,
        };
