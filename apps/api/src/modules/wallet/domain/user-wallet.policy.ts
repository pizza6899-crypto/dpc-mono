...
export class UserWalletPolicy {
     ...
     */
    canPerformTransaction(wallet: UserWallet, type: UserWalletTransactionType): void {
        ...
        switch (type) {
            ...
            case UserWalletTransactionType.BONUS_OUT:
                ...
                const allowedStatuses: UserWalletStatus[] = [UserWalletStatus.ACTIVE, UserWalletStatus.WITHDRAWAL_RESTRICTED];
            ...
            default:
                ...
                if (status !== UserWalletStatus.ACTIVE && status !== UserWalletStatus.WITHDRAWAL_RESTRICTED) {
                    throw new WalletStatusException(`Transaction ${type} is not allowed in ${status} status`);
                }
                break;
        }
