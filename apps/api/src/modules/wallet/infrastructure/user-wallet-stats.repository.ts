        ...
        await this.tx.$kysely
            ...
            .onConflict((oc) => oc
                ...
                .doUpdateSet((eb) => ({
                    ...
                    last_bet_at: isNewBet ? now : sql`user_wallet_total_stats.last_bet_at`,
                    last_win_at: isNewWin ? now : sql`user_wallet_total_stats.last_win_at`,
                    last_deposit_at: isNewDeposit ? now : sql`user_wallet_total_stats.last_deposit_at`,
                    last_withdraw_at: isNewWithdraw ? now : sql`user_wallet_total_stats.last_withdraw_at`,
        ...
        await this.tx.$kysely
            ...
            .onConflict((oc) => oc
                ...
                .doUpdateSet((eb) => ({
                    ...
                    last_bet_at: isNewBet ? now : sql`user_wallet_hourly_stats.last_bet_at`,
                    last_win_at: isNewWin ? now : sql`user_wallet_hourly_stats.last_win_at`,
                    last_deposit_at: isNewDeposit ? now : sql`user_wallet_hourly_stats.last_deposit_at`,
                    last_withdraw_at: isNewWithdraw ? now : sql`user_wallet_hourly_stats.last_withdraw_at`,
