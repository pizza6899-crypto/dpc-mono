...
export class CryptoGroupSimpleDto {
  @ApiProperty({
    ...
    description: 'Currency symbol (Coin)',
    example: 'USDT',
  })
  symbol: ExchangeCurrencyCode;

  @ApiProperty({
    type: [CryptoNetworkSimpleDto],
...
export class BankGroupSimpleDto {
  ...
  @ApiProperty({
    description: 'Minimum deposit amount for this currency',
    example: '10000',
  })
  minAmount: string;
}
...
export class GetAvailableDepositMethodsResponseDto {
  @ApiProperty({
    type: [BankGroupSimpleDto],
    description: 'Available bank currencies',
  })
  bank: BankGroupSimpleDto[];

  @ApiProperty({
    type: [CryptoGroupSimpleDto],
    description: 'Available crypto methods',
  })
