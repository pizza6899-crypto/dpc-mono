...
export class CryptoDepositAddressResponseDto {
    ...
    @ApiPropertyOptional({ description: 'Generated deposit address (Wallet Address)' })
    payAddress?: string;

    @ApiPropertyOptional({ description: 'Extra ID for deposit (Tag, Memo, etc.)', nullable: true })
    payAddressExtraId?: string | null;

    @ApiProperty({ description: 'Unique identifier for this deposit request (Record UID)' })
    depositUid: string;
}
...
export class BankDepositAddressResponseDto {
    ...
    @ApiProperty({ description: 'Instructions or description for the user', nullable: true })
...
export class UserDepositResponseDto {
    ...
    @ApiProperty({ description: 'Wallet address used (for crypto)', nullable: true })
