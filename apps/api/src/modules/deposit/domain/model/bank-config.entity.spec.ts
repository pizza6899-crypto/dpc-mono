...
describe('BankConfig Entity', () => {
  ...
  describe('amount validation', () => {
    it('isAmountAboveMinimum should return true when amount >= minAmount', () => {
      ...
      expect(config.isAmountAboveMinimum(new Prisma.Decimal('10000'))).toBe(
        true,
      );
      expect(config.isAmountAboveMinimum(new Prisma.Decimal('50000'))).toBe(
        true,
      );
      expect(config.isAmountAboveMinimum(new Prisma.Decimal('9999'))).toBe(
        false,
      );
    });
    ...
    it('isAmountBelowMaximum should return true when no max limit', () => {
      ...
      expect(config.isAmountBelowMaximum(new Prisma.Decimal('999999999'))).toBe(
        true,
      );
    });
    ...
    it('isAmountBelowMaximum should return true when amount <= maxAmount', () => {
      ...
      expect(config.isAmountBelowMaximum(new Prisma.Decimal('1000000'))).toBe(
        true,
      );
      expect(config.isAmountBelowMaximum(new Prisma.Decimal('500000'))).toBe(
        true,
      );
      expect(config.isAmountBelowMaximum(new Prisma.Decimal('1000001'))).toBe(
        false,
      );
    });
