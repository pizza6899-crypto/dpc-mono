...
export class FileNotFoundException extends FileException {
    constructor(identifier: string | bigint) {
        ...
        super(`File not found: ${id}`, MessageCode.FILE_NOT_FOUND, HttpStatus.NOT_FOUND);
...
export class FileUploadFailedException extends FileException {
    constructor(message: string) {
        super(`File upload failed: ${message}`, MessageCode.FILE_UPLOAD_FAILED, HttpStatus.INTERNAL_SERVER_ERROR);
