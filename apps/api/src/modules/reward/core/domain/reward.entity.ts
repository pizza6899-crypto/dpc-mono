...
import { ExchangeCurrencyCode, RewardItemType, RewardSourceType, RewardStatus, WageringTargetType } from '@prisma/client';
import Decimal from 'decimal.js';
import { RewardMetadata } from './reward.types';
import {
...
export class UserReward {
    ...
    public static create(params: {
        ...
        return new UserReward({
            ...
            wageringTargetType: params.wageringTargetType ?? WageringTargetType.AMOUNT,
    ...
    get sourceType(): RewardSourceType { return this.props.sourceType; }
    get sourceId(): bigint | null { return this.props.sourceId; }

    get rewardType(): RewardItemType { return this.props.rewardType; }
    get currency(): ExchangeCurrencyCode { return this.props.currency; }
    get amount(): Decimal { return this.props.amount; }

    get wageringTargetType(): WageringTargetType { return this.props.wageringTargetType; }
    get wageringMultiplier(): Decimal | null { return this.props.wageringMultiplier; }
    get wageringExpiryDays(): number | null { return this.props.wageringExpiryDays; }
    get maxCashConversion(): Decimal | null { return this.props.maxCashConversion; }
    get isForfeitable(): boolean { return this.props.isForfeitable; }

    get status(): RewardStatus { return this.props.status; }
    ...
    get metadata(): RewardMetadata | null { return this.props.metadata; }
