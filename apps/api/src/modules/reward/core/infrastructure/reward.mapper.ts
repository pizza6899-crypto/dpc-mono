...
import type { UserReward as PrismaUserReward } from '@prisma/client';
import { Prisma } from '@prisma/client';
import type { UserRewardProps } from '../domain/reward.entity';
import { UserReward } from '../domain/reward.entity';
import type { RewardMetadata } from '../domain/reward.types';
...
export class RewardMapper {
  ...
  static toDomain(prismaModel: PrismaUserReward): UserReward {
    const props: UserRewardProps = {
      ...
      wageringMultiplier: prismaModel.wageringMultiplier
        ? new Decimal(prismaModel.wageringMultiplier.toString())
        : null,
      wageringExpiryDays: prismaModel.wageringExpiryDays,
      maxCashConversion: prismaModel.maxCashConversion
        ? new Decimal(prismaModel.maxCashConversion.toString())
        : null,
      ...
      metadata: prismaModel.metadata
        ? (prismaModel.metadata as unknown as RewardMetadata)
        : null,
  ...
  static toPersistence(
    entity: UserReward,
  ): Prisma.UserRewardUncheckedCreateInput {
    ...
    return {
      ...
      metadata: props.metadata
        ? (props.metadata as unknown as Prisma.InputJsonValue)
        : Prisma.DbNull,
