...
export class CompUserController {
  ...
  //   description:
  //     'Convert accumulated comp points to actual cash balance / 누적된 콤프 포인트를 실제 현금 잔액으로 전환합니다.',
  // })
  ...
  //     rewardId: this.sqidsService.encode(result.rewardId, SqidsPrefix.REWARD),
  //   };
  // }
  ...
  //       compWalletId: this.sqidsService.encode(
  //         item.compWalletId,
  //         SqidsPrefix.COM_WALLET,
  //       ),
