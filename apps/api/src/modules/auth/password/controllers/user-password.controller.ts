...
export class UserPasswordController {
  ...
  @ApiOperation({
    ...
    description:
      'Sends a reset token via email if the password is forgotten. / 비밀번호를 잊은 경우 이메일로 재설정 토큰을 발송합니다.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Resets the password using the token received via email. / 이메일로 받은 토큰을 사용하여 비밀번호를 재설정합니다.',
  })
