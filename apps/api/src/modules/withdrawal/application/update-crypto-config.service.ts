...
export class UpdateCryptoConfigService {
    ...
    async execute(params: UpdateCryptoConfigParams): Promise<CryptoWithdrawConfig> {
        ...
        if (params.autoProcessLimit !== undefined) updates.autoProcessLimit = params.autoProcessLimit ? new Prisma.Decimal(params.autoProcessLimit) : null;
