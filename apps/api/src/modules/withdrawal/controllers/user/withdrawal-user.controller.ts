...
export class WithdrawalUserController {
    ...
    @ApiOperation({
        ...
        description: '현재 로그인한 사용자의 출금 신청 내역을 페이징하여 조회합니다.',
    })
    ...
    async requestCryptoWithdrawal(
        ...
        return {
            withdrawalId: this.sqidsService.encode(result.withdrawalId, SqidsPrefix.WITHDRAWAL),
    ...
    @ApiOperation({
        ...
        description: '사용 가능한 출금 수단(암호화폐, 은행) 및 관련 설정을 조회합니다.',
    })
