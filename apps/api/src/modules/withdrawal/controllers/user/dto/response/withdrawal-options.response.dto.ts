...
export class CryptoWithdrawOptionDto {
    ...
    @ApiProperty({ description: 'Maximum withdrawal amount', example: '10000', nullable: true })
...
export class BankWithdrawOptionDto {
    ...
    @ApiProperty({ description: 'Maximum withdrawal amount', example: '10000000', nullable: true })
    maxAmount: string | null;
...
export class WithdrawalOptionsResponseDto {
    @ApiProperty({ type: [CryptoWithdrawOptionDto], description: 'Available crypto withdrawal options' })
    crypto: CryptoWithdrawOptionDto[];

    @ApiProperty({ type: [BankWithdrawOptionDto], description: 'Available bank withdrawal options' })
