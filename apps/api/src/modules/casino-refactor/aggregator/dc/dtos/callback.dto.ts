...
// 공통 응답 데이터 DTO
export class DcResponseDataDto {
  @ApiProperty({
...
// 공통 응답 DTO
export class DcCommonResponseDto {
  @ApiProperty({
    description: 'DC API Response Code',
    example: 1,
    type: Number,
  })
  code: number;
  ...
  @ApiProperty({
    ...
    type: DcResponseDataDto,
  })
  data?: DcResponseDataDto | {};
}

// Login Request/Response
export class DcLoginRequestDto {
  @ApiProperty({
...
export class DcLoginResponseDto extends DcCommonResponseDto {}

// Wager Request/Response
export class DcWagerRequestDto {
  @ApiProperty({
    description: 'Brand ID',
    example: 'brand123',
    maxLength: 9,
...
export class DcWagerResponseDto extends DcCommonResponseDto {}

// Cancel Wager Request/Response
export class DcCancelWagerRequestDto {
  @ApiProperty({
    description: 'Brand ID',
    example: 'brand123',
    maxLength: 9,
...
export class DcCancelWagerResponseDto extends DcCommonResponseDto {}

// Append Wager Request/Response
export class DcAppendWagerRequestDto {
  @ApiProperty({
    description: 'Brand ID',
    example: 'brand123',
    maxLength: 9,
...
export class DcAppendWagerResponseDto extends DcCommonResponseDto {}

// End Wager Request/Response
export class DcEndWagerRequestDto {
  @ApiProperty({
    description: 'Brand ID',
    example: 'brand123',
    maxLength: 9,
...
export class DcEndWagerResponseDto extends DcCommonResponseDto {}

// Free Spin Result Request/Response
export class DcFreeSpinResultRequestDto {
  @ApiProperty({
    description: 'Brand ID',
    example: 'brand123',
    maxLength: 9,
...
export class DcFreeSpinResultResponseDto extends DcCommonResponseDto {}

// Get Balance Request/Response
export class GetDcBalanceRequestDto {
  @ApiProperty({
    description: 'Brand ID',
    example: 'brand123',
    maxLength: 9,
...
export class GetDcBalanceResponseDto extends DcCommonResponseDto {}

// Promo Payout Request/Response
export class DcPromoPayoutRequestDto {
  @ApiProperty({
    description: 'Brand ID',
    example: 'brand123',
    maxLength: 9,
...
export class DcPromoPayoutResponseDto extends DcCommonResponseDto {}
