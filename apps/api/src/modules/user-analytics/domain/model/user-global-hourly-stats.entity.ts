...
export class UserGlobalHourlyStats {
  ...
  get hourlyDepositUsd(): Prisma.Decimal {
    return this._hourlyDepositUsd;
  }
  get hourlyWithdrawUsd(): Prisma.Decimal {
    return this._hourlyWithdrawUsd;
  }
  get hourlyBetUsd(): Prisma.Decimal {
    return this._hourlyBetUsd;
  }
  get hourlyWinUsd(): Prisma.Decimal {
    return this._hourlyWinUsd;
  }
  get hourlyPromoUsd(): Prisma.Decimal {
    return this._hourlyPromoUsd;
  }
}
