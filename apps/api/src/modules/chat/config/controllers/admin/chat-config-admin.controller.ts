...
import { ApiBearerAuth, ApiOperation, ApiTags, ApiCookieAuth } from '@nestjs/swagger';
...
export class ChatConfigAdminController {
    ...
    @ApiOperation({
        ...
        description: 'Updates global settings for the chat system. / 채팅 시스템의 전역 설정을 수정합니다.',
    })
    @ApiStandardResponse(ChatConfigAdminResponseDto)
    @AuditLog({
