...
import { ChatRoomMember, type ChatRoomMemberRawPayload } from '../domain/chat-room-member.entity';
import { Cast } from '../../../../infrastructure/persistence/persistence.util';

export class ChatRoomMemberMapper {
    public static toDomain(data: PersistenceOf<ChatRoomMemberRawPayload>): ChatRoomMember {
