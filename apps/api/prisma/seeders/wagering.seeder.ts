        ...
        await prisma.wageringConfig.create({
            data: {
                ...
                currencySettings: {
                    ...
                    BTC: { cancellationThreshold: 0.00001, minBetAmount: 0.000001, maxBetAmount: 0.0001 },
                    ETH: { cancellationThreshold: 0.0001, minBetAmount: 0.0001, maxBetAmount: 0.005 },
                    USDT: { cancellationThreshold: 0.5, minBetAmount: 0.1, maxBetAmount: 5 },
                },
