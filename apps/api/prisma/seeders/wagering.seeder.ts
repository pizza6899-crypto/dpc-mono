    ...
    if (!existingConfig) {
        await prisma.wageringConfig.create({
            data: {
                ...
                currencySettings: {
                    KRW: { cancellationThreshold: 500, minBetAmount: 100 },
                    USD: { cancellationThreshold: 0.5, minBetAmount: 0.1 },
                    BTC: { cancellationThreshold: 0.00001, minBetAmount: 0.000001 },
                    ETH: { cancellationThreshold: 0.0001, minBetAmount: 0.0001 },
                    USDT: { cancellationThreshold: 0.5, minBetAmount: 0.1 },
                },
