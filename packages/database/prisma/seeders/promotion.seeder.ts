import { Language, Prisma, PrismaClient, PromotionQualificationCondition } from '../../src';
...
export async function seedPromotions(prisma: PrismaClient) {
  ...
  const firstDepositPromotion = await prisma.promotion.upsert({
    ...
    create: {
      ...
      bonusRate: new Prisma.Decimal(1.0), // 100%
      minDepositAmount: new Prisma.Decimal(10), // 최소 10 USDT
      maxBonusAmount: new Prisma.Decimal(1000), // 최대 1000 USDT
      rollingMultiplier: new Prisma.Decimal(20.0), // 20배 롤링
