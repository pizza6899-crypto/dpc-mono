export enum MessageCode {
    ...
    DEPOSIT_ENTITY_NOT_PERSISTED = 'DEPOSIT_ENTITY_NOT_PERSISTED', // 입금 엔티티가 영속화되지 않았을 때 (ID 미발급)
    DEPOSIT_ENTITY_ALREADY_PERSISTED = 'DEPOSIT_ENTITY_ALREADY_PERSISTED', // 입금 엔티티가 이미 영속화되었을 때 (ID 중복)
