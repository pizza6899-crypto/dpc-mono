export enum MessageCode {
    ...
    GAMIFICATION_CONFIG_INVALID = 'GAMIFICATION_CONFIG_INVALID', // 게이미피케이션 설정이 유효하거나 파라미터가 잘못된 경우
    ...
    GAMIFICATION_CONFIG_NEGATIVE_VALUE = 'GAMIFICATION_CONFIG_NEGATIVE_VALUE', // 설정값이 음수일 때 (상세항목은 메시지로 구분 가능하거나 코드를 추가 가능)
    GAMIFICATION_CONFIG_XP_MULTIPLIER_NEGATIVE = 'GAMIFICATION_CONFIG_XP_MULTIPLIER_NEGATIVE', // XP 배율이 음수일 때
    GAMIFICATION_CONFIG_STAT_LIMIT_NEGATIVE = 'GAMIFICATION_CONFIG_STAT_LIMIT_NEGATIVE', // 스탯 한계치가 음수일 때
    GAMIFICATION_CONFIG_STAT_POINTS_NEGATIVE = 'GAMIFICATION_CONFIG_STAT_POINTS_NEGATIVE', // 스탯 포인트 부여량이 음수일 때
    GAMIFICATION_CONFIG_PRICE_NEGATIVE = 'GAMIFICATION_CONFIG_PRICE_NEGATIVE', // 초기화 가격이 음수일 때
    GAMIFICATION_LEVEL_REQUIRED_XP_NEGATIVE = 'GAMIFICATION_LEVEL_REQUIRED_XP_NEGATIVE', // 레벨 필요 경험치가 음수일 때
    GAMIFICATION_LEVEL_STAT_BOOST_NEGATIVE = 'GAMIFICATION_LEVEL_STAT_BOOST_NEGATIVE', // 레벨업 스탯 보상이 음수일 때
    GAMIFICATION_CONFIG_CURRENCY_NOT_SUPPORTED = 'GAMIFICATION_CONFIG_CURRENCY_NOT_SUPPORTED', // 지원하지 않는 통화일 때

    GAMIFICATION_CHARACTER_NOT_FOUND = 'GAMIFICATION_CHARACTER_NOT_FOUND', // 유저 캐릭터 정보를 찾을 수 없을 때
    GAMIFICATION_CHARACTER_INSUFFICIENT_XP = 'GAMIFICATION_CHARACTER_INSUFFICIENT_XP', // 보유 경험치가 부족할 때
    GAMIFICATION_CHARACTER_INSUFFICIENT_STAT_POINTS = 'GAMIFICATION_CHARACTER_INSUFFICIENT_STAT_POINTS', // 보유 스탯 포인트가 부족할 때
    GAMIFICATION_CHARACTER_STAT_LIMIT_EXCEEDED = 'GAMIFICATION_CHARACTER_STAT_LIMIT_EXCEEDED', // 스탯 투자 상한선을 초과했을 때
    GAMIFICATION_CHARACTER_INVALID_STAT_TYPE = 'GAMIFICATION_CHARACTER_INVALID_STAT_TYPE', // 유효하지 않은 스탯 타입일 때
