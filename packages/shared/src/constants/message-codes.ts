export enum MessageCode {
    ...
    GAMIFICATION_CONFIG_EXP_MULTIPLIER_NEGATIVE = 'GAMIFICATION_CONFIG_EXP_MULTIPLIER_NEGATIVE', // 경험치 배율이 음수일 때
    GAMIFICATION_CONFIG_STAT_LIMIT_NEGATIVE = 'GAMIFICATION_CONFIG_STAT_LIMIT_NEGATIVE', // 스탯 한계치가 음수일 때
    GAMIFICATION_CONFIG_STAT_POINT_NEGATIVE = 'GAMIFICATION_CONFIG_STAT_POINT_NEGATIVE', // 스탯 포인트 부여량이 음수일 때
